...
const DEFAULT_DAILY_DIR = "/Users/<Owner>/switchboard/dailynote";
...
function resolveDailyDir() {
  return expandHomeDir(process.env.DAILY_NOTE_PATH || DEFAULT_DAILY_DIR);
}

function resolveVaultRoot(dailyDir = resolveDailyDir()) {
  return path.resolve(dailyDir, "..");
}

function parseReminderListOutput(listOutput) {
