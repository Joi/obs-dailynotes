...
chmod +x /Users/joi/obs-dailynotes/debug_mail.sh
chmod +x /Users/joi/obs-dailynotes/tools/debugMailSearch.js
chmod +x /Users/joi/obs-dailynotes/tools/searchMailApp.js

# Run debug script
echo "Step 1: Running detailed diagnostics..."
echo "----------------------------------------"
node /Users/joi/obs-dailynotes/tools/debugMailSearch.js
