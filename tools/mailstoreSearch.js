...
try {
  ...
  execSync('npm install imap', { cwd: '/Users/<Owner>/obs-dailynotes', stdio: 'inherit' });
}
  ...
  searchPerson(email, name, limit = 20) {
    return new Promise((resolve, reject) => {
      ...
      const foldersToSearch = [
        ...
        '<Owner>/joiito@gmail.com/Inbox',
        '<Owner>/ji@example.edu/Inbox',
        '<Owner>/<Owner>@example.com/Inbox',
        '<Owner>/jito@neoteny.com/Inbox',
        '<Owner>/<Owner>@example.jp/Inbox'
      ];
